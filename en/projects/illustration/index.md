...
description: Here are my project highlights

hero:
  name: Illustration Projects
  tagline: Portfolio of development, creative, and design projects.

features:
  - title: Comic Samples Gallery
    ...
    linkOld: /en/art/comics
    linkOldText: Presentation
    link: ./docs/comic-samples-gallery.md
    linkText: View
